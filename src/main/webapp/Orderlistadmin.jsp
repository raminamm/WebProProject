<%-- 
    ...
    Created on : Nov 9, 2020, 3:49:16 PM
    Author     : Rachawas
--%>
...
<html lang="en">
    ...
    <jsp:include page="/WEB-INF/Headeradmin.jsp?title=Orderlistadmin"/>
            ...
            <tr>
                <td align=center valign=middle>
                    ...
                    <div class="his_section">
                        ...
                        <div class="col">
                            <p class="mt-5 mb-5" style="color: #000000;font-size: 20px;">Order list </p>
                        </div>                            
                            <c:forEach items="${orderadmin}" var="o" varStatus="vs">

                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="his_container">                          

                                        <a href="Orderdetailadmin?orderid=${o.orderid}" class="notification-link">
                                            <div class="his_items">
                                                    <ul class="his_list">                                                            
                                                        ...
                                                        <li class="his_item clearfix">                                                
                                                            ...
                                                            <div class="his_item_info d-flex flex-md-row flex-column justify-content-between">
                                                                ...
                                                                <div class="his_item_name his_info_col">
                                                                    ...
                                                                    <div class="his_item_text">${o.orderid}</div>
                                                                </div>
                                                                ...
                                                                <div class="his_item_color his_info_col">
                                                                    ...
                                                                    <div class="his_item_text">${o.address}</div>
                                                                </div>

                                                                <div class="his_item_quantity his_info_col">
                                                                    <div class="his_item_title"><strong style="font-size: 19px;">Email</strong></div>
                                                                    <div class="his_item_text">${o.email.email}</div>
                                                                </div>
                        ...
                        <a style="text-decoration: none" href="" type="button" class="button back">Back</a> </div>
                </div>
