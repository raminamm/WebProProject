                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img style="width:210px ;height:210px ;" src="ไว้ลอง/Loose fit t-shirt-B.jpg" /> </td>
                                            <td>Product Name</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td><img style="width:210px ;height:210px ;" src="ไว้ลอง/Loose fit t-shirt-D.OR.jpg" /> </td>
                                            <td>Product Name</td>
                                            <td></td>
                                            <td><input class="form-control" type="number" value="1" /></td>
                                            <td class="text-right"> ฿</td>
                                        ...
                                        <tr>
                                            <td><img style="width:210px ;height:210px ;" src="ไว้ลอง/Loose fit t-shirt-Gray.jpg" /> </td>
                                            <td>Product Name</td>
                                            <td></td>
                                            <td><input class="form-control" type="number" value="1" /></td>
                                            <td class="text-right"> ฿</td>
